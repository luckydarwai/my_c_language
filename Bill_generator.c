// Here, in this program we need to check where is a error . and we need to fixed this error, so pleace work on this program and i hope next time I'll get solution of this program .
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
